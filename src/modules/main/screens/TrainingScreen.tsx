...
import { TodayWorkoutView } from '@/shared/components/TodayWorkoutView';
import { HistoryView } from '@/shared/components/HistoryView';
...
export function TrainingScreen({ navigation }: Props) {
  ...
  useEffect(() => {
    loadUserName().then((n) => { setUserName(n ?? ''); setNameLoaded(true); });
  }, []);
